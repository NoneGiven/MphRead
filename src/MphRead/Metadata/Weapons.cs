...
namespace MphRead
{
    ...
    public class WeaponInfo
    {
        ...
        public WeaponInfo(BeamType beam, BeamType beamKind, byte[] drawFuncIds, ushort[] colors, byte priority, WeaponFlags flags,
            ...
            int unchargedHoming, int minChargeHoming, int chargedHoming, int homingRange, int homingTolerance, int unchargedScale, int minChargeScale,
            int chargedScale, int unchargedDistance, int minChargeDistance, int chargedDistance, int unchargedSpread, int minChargeSpread,
