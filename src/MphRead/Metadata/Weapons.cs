...
namespace MphRead
{
    ...
    public class WeaponInfo
    {
        ...
        public WeaponInfo(BeamType weapon, BeamType weaponType, byte[] drawFuncIds, ushort[] colors, byte priority, WeaponFlags flags,
            ...
            ushort padding42, ushort[] speedInterp, int field48, int field4C, int field50, int field54, int field58, int field5C, int field60,
            int unchargedSpeed, int minChargeSpeed, int chargedSpeed, int unchargedFinalSpeed, int minChargeFinalSpeed, int chargedFinalSpeed,
            int unchargedGravity, int minChargeGravity, int chargedGravity, int unchargedHoming, int minChargeHoming, int chargedHoming,
            int homingRange, int homingTolerance, int unchargedScale, int minChargeScale, int chargedScale, int unchargedDistance,
            int minChargeDistance, int chargedDistance, int unchargedSpread, int minChargeSpread, int chargedSpread, int unRicoLossH,
            int minRicoLossH, int chRicoLossH, int unRicoLossV, int minRicoLossV, int chRicoLossV, uint[] ricochetWeapon, ushort projectileCount,
            ushort minChargedProjectileCount, ushort chargeProjectileCount, ushort smokeStart, ushort smokeMinimum, ushort smokeDrain,
            ushort smokeShotAmount, ushort smokeChargeAmount, string description)
        {
