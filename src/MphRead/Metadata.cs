            ...
            = new Dictionary<string, EntityMetadata>()
            {
                ...
                // not part of the game's files, edited to allow choosing the unused recolors
                {
                    ...
                    new EntityMetadata("GuardianR_lod0",
                        modelPath: @"models\GuardianR_lod1_Model.bin",
                        animationPath: @"_archives\Guardian\Guardian_Anim.bin",
                        collisionPath: null,
                        new List<RecolorMetadata>()
                        {
                            new RecolorMetadata("pal_01",
                                modelPath: @"model\GuardianR_pal_01_Model.bin",
                                texturePath: @"model\GuardianR_pal_01_Tex.bin",
                                palettePath: @"model\GuardianR_pal_01_Tex.bin"),
                            new RecolorMetadata("pal_02",
                                modelPath: @"model\GuardianR_pal_02_Model.bin",
                                texturePath: @"model\GuardianR_pal_02_Tex.bin",
                                palettePath: @"model\GuardianR_pal_02_Tex.bin"),
                            new RecolorMetadata("pal_03",
                                modelPath: @"model\GuardianR_pal_03_Model.bin",
                                texturePath: @"model\GuardianR_pal_03_Tex.bin",
                                palettePath: @"model\GuardianR_pal_03_Tex.bin"),
                            new RecolorMetadata("pal_04",
                                modelPath: @"model\GuardianR_pal_04_Model.bin",
                                texturePath: @"model\GuardianR_pal_04_Tex.bin",
                                palettePath: @"model\GuardianR_pal_04_Tex.bin"),
                            new RecolorMetadata("pal_Team01",
                                modelPath: @"model\GuardianR_pal_Team01_Model.bin",
                                texturePath: @"model\GuardianR_pal_Team01_Tex.bin",
                                palettePath: @"model\GuardianR_pal_Team01_Tex.bin"),
                            new RecolorMetadata("pal_Team02",
                                modelPath: @"model\GuardianR_pal_Team02_Model.bin",
                                texturePath: @"model\GuardianR_pal_Team02_Tex.bin",
                                palettePath: @"model\GuardianR_pal_Team02_Tex.bin")
                        })
                },
                {
                    "Guardian_Stasis",
